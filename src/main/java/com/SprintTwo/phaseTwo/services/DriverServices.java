...
import com.SprintTwo.phaseTwo.repositorys.FavRepo;
import com.SprintTwo.phaseTwo.repositorys.RidesRepo;
import com.SprintTwo.phaseTwo.repositorys.SuccessfulRideRepo;
...
public class DriverServices {
    ...
    public Driver cancelRide(long rideId) {
        ...
        SuccessfulRide successfulRide = successfulRideRepo.findSuccessfulRideByRide(ride);
        driver.getFavouriteAreas().remove(favouriteAreas);
        favRepo.delete(favouriteAreas);
        successfulRideRepo.delete(successfulRide);
